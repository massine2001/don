      ...
      {!user && <MainLayout>
        <div className='grand-redirect'>
          <div className='petit-redirect'>
            <h2>Vous devez être connecté pour demander une aide personnalisée, afin de faciliter la communication entre vous !</h2>
        ...
        <MainLayout>
          <div className='standard-container'>
            <div className='standard-card'>
              <h2 className='request-form-titre'>Formulaire de demande d'aide</h2>
              {successMessage && <div className="success-message">{successMessage}</div>}
              <form onSubmit={handleSubmit} className="standard-form">
                <label>Ville</label>
                <input type="text" value={name} onChange={(e) => setName(e.target.value)} />
                <label>Type de l'aide</label>
                ...
                <label>Description de l'aide demandée</label>
